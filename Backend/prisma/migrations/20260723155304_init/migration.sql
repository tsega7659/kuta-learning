-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STUDENT', 'CONTENT_MANAGER');

-- CreateEnum
CREATE TYPE "ContentType" AS ENUM ('TEXT', 'VIDEO', 'AUDIO', 'DOCUMENT');

-- CreateEnum
CREATE TYPE "QuestionType" AS ENUM ('SINGLE_CHOICE', 'COLOR_MATCH', 'WORD_ORDER', 'MULTIPLE_CHOICE', 'MATCHING', 'TRUE_FALSE', 'FILL_IN_BLANK', 'DRAG_AND_DROP');
...
-- AddForeignKey
ALTER TABLE "QuizAnswer" ADD CONSTRAINT "QuizAnswer_selectedOptionId_fkey" FOREIGN KEY ("selectedOptionId") REFERENCES "QuestionOption"("id") ON DELETE CASCADE ON UPDATE CASCADE;
